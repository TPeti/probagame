...
var ExtensionCodec = (
  ...
  function() {
    ...
    ExtensionCodec2.prototype.register = function(_a2) {
      var type = _a2.type, encode3 = _a2.encode, decode3 = _a2.decode;
      if (type >= 0) {
...
var Encoder2 = (
  ...
  function() {
    ...
    Encoder3.prototype.encodeSharedRef = function(object) {
...
var Decoder2 = (
  ...
  function() {
    ...
    Decoder3.prototype.setBuffer = function(buffer) {
      this.bytes = ensureUint8Array(buffer);
      this.view = createDataView(this.bytes);
      this.pos = 0;
    };
    Decoder3.prototype.appendBuffer = function(buffer) {
    ...
    Decoder3.prototype.decode = function(buffer) {
      this.reinitializeState();
      this.setBuffer(buffer);
    ...
    Decoder3.prototype.decodeMulti = function(buffer) {
...
function decodeMultiStream(streamLike, options) {
  ...
  var decoder2 = new Decoder2(options.extensionCodec, options.context, options.maxStrLength, options.maxBinLength, options.maxArrayLength, options.maxMapLength, options.maxExtLength);
...
var $dcf98445f54823f4$var$iterateOver = async function* (stream) {
...
var $dcf98445f54823f4$export$7e9583c3c8a0a2cc = class extends (0, $20dbe68149d7aad9$export$72aa44612e2200cd) {
  constructor(peerId, provider, options) {
    super(peerId, provider, {
      ...options,
      reliable: true
      ...
      transform: (abchunk, controller) => {
        ...
        try {
          ...
          for (let value of values || []) {
            if (value === null)
              value = $dcf98445f54823f4$var$NullValue;
...
var $3849fc09dd8f140b$export$f6a74c7ffa2903e6 = class extends (0, $416260bce337df90$export$ecd1fc136c422448) {
  constructor(...args) {
    super(...args);
    this._serializers = {
...
export {
  ...
  $dcf98445f54823f4$export$7e9583c3c8a0a2cc as Cbor,
  $3849fc09dd8f140b$export$f6a74c7ffa2903e6 as CborPeer,
